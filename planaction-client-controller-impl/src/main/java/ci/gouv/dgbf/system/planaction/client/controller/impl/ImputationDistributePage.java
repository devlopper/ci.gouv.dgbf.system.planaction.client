...
public class ImputationDistributePage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected String __getWindowTitleValue__() {
		return "Répartition des crédits de paiements par source de financement de l'imputation "+imputation;
	}	
}